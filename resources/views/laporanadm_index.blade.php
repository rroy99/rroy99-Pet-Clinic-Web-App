...
<body style="background: white;">
    <div class="container-fluid">
        <div class="col-md-12">
            <h3 class="text-center">LAPORAN ADMINISTRASI <br> PET CARE BATAM</h3>
                    ...
                    <tbody>
                        @foreach ($adm as $item)
                            <tr>
                                ...
                                <td>
                                    <dl class="row">
                                        <dt class="col-md-4">Nama dan Jenis Hewan Peliharaan</dt>
                                        <dd class="col-md-8">: {{ $item->pasien->nama_pasien }}</dd>

                                        <dt class="col-md-4">Nama dan No.HP Pemilik Peliharaan</dt>
                                        <dd class="col-md-8">: {{ $item->pasien->nomor_hp }}</dd>

                                        <dt class="col-md-4">Tujuan Layanan</dt>
