            ...
            <form action="/dokter" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mt-3">
                    ...
                    <select name="spesialis" class="form-control">
                        <option value="Bedah_Hewan" @selected(old('spesialis') == 'Bedah_Hewan')> Spesialis Bedah Hewan</option>
                        <option value="Gigi_Hewan" @selected(old('spesialis') == 'Gigi_Hewan')> Spesialis Perawatan Gigi Hewan</option>
                        <option value="Penyakit_Dalam_Hewan" @selected(old('spesialis') == 'Penyakit_Dalam_Hewan')> Spesialis Penyakit Dalam Hewan</option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mt-3">
                            <label for="tiktok">Akun Linkedin</label>
