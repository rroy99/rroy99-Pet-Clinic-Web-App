            ...
            <form action="/dokter/{{ $dokter->id }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mt-3">
                    ...
                    <select name="spesialis" class="form-control">
                        <option value="Bedah_Hewan" @selected($dokter->spesialis == 'Bedah_Hewan')> Spesialis Bedah Hewan</option>
                        <option value="Gigi_Hewan" @selected($dokter->spesialis == 'Gigi_Hewan')> Spesialis Perawatan Gigi Hewan</option>
                        <option value="Penyakit_Dalam_Hewan" @selected($dokter->spesialis == 'Penyakit_Dalam_Hewan')>
                        Spesialis Penyakit Dalam Hewan
                        </option>
